                ...
                <div class="mb-3">
                    ...
                    <select class="form-control" id="numventa" name="numventa">
                        ...
                        @foreach ($numventa as $numventas)
                            <option value="{{ $numventas->id }}">{{ $numventas->numventa }}</option>
                        @endforeach
                    </select>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control" id="idcliente" name="idcliente">
                        ...
                        @foreach ($cliente as $clientes)
                            <option value="{{ $clientes->id }}">{{ $clientes->nomcliente }}</option>
                        @endforeach
                    </select>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control" id="idempleado" name="idempleado">
                        ...
                        @foreach ($empleado as $empleados)
                            <option value="{{ $empleados->id }}">{{ $empleados->nomempleado }}</option>
                        @endforeach
                    </select>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control" id="idformapago" name="idformapago">
                        ...
                        @foreach ($formapago as $formapagos)
                            <option value="{{ $formapagos->id }}">{{ $formapagos->formapago }}</option>
                        @endforeach
                    </select>
